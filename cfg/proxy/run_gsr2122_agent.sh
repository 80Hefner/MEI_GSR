...
[snmpd]
view gsr2122 included 1.3.6.1.4.101
rwcommunity local 10.0.1.20 -V gsr2122
rwcommunity manager 10.0.1.21 -V gsr2122
agentaddress 10.0.1.20:5555
informsink 10.0.1.20:5556
smuxsocket 10.0.1.20:5557
master agentx
...
python3 gsr2122_agent.py -m $TMPDIR/snmpd-agentx.sock -p $TMPDIR/
